  ...
  Edit modal
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link active" href="societymemberchairman.php">Society Info</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container my-3 p-5 border border-3 rounded border-dark text-white" style="background:black;">
